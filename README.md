# Engineering Brain and Body Interface Systems

## Introduction

Welcome to an exploration of how to process signals from the brain and body for the purposes of controlling external effectors, diagnosing medical conditions, providing feedback to users about their state, or delivering therapy. This course is designed for upper-division students in electrical engineering, computer science, and neuroscience who want to move beyond theory and directly engage with the tools and principles used to measure biological signals, process data, design algorithms, and build closed-loop systems.

## How to complete labs (using lab1 as example)

- Go to this week's lab directory `lab1/`.
- Start by going through the markdown file `lab1.md`.
- Complete `lab1.ipynb`.
